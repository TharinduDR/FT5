...
for i in range(FOLDS):
    ...
    sold_train["prefix"] = "olid_a"
    sold_train = sold_train.rename(columns={'text': 'input_text', 'label': 'target_text'})
    sold_train = sold_train[["prefix", "input_text", "target_text"]]

    train_df, eval_df = train_test_split(sold_train, test_size=0.2, random_state=SEED * i)
    ...
    model_name_prefix = "SOLD" + model_name
    ...
    macro_f1, weighted_f1 = sentence_label_evaluation(preds, sold_test["label"].tolist())
